...
; Puerto B
; PB0 = D8  push boton modo
; PB1 = D9  LED1
; PB2 = D10 push boton decrementar
; PB3 = D11 LED2
; PB4 = D12 push boton incrementar
; PB5 = D13 buzzer

LDI R16,(1<<DDB1)|(1<<DDB3)|(1<<DDB5)
OUT DDRB,R16

LDI R16,(1<<PB0)|(1<<PB2)|(1<<PB4)
OUT PORTB,R16
	...
	LDI		R16, (1<<TOIE0)
	STS		TIMSK0, R16
	; PCINT en PORTB: PB0 modo, PB3 inc, PB4 dec
	LDI		R16, (1<<PCIE0)
	STS		PCICR, R16
...
MOSTRAR_MODO:
	...
	; modo 0 = hora -> solo LED hora
	CPI		R17, 0x00
	BREQ	MODO_HORA_LED

	; modo 1 = fecha -> solo LED fecha
	CPI		R17, 0x01
	BREQ	MODO_FECHA_LED

	; modo 2 = configurar hora -> ambos LEDs
	CPI		R17, 0x02
	BREQ	MODO_CFG_HORA_LED

	; modo 3 = configurar fecha -> ambos apagados
	CPI		R17, 0x03
	BREQ	MODO_CFG_FECHA_LED

	; para los demás modos, lo dejo como estaba: LED hora
	ORI		R16, (1<<PB1)
	RJMP	CHECK_ALARMA_LED
...
PINB_ISR:
	...
	; INCREMENTAR en PB3 (D11)
	SBRS	R16, PB3
	RJMP	SET_INCREMENTAR

	; DECREMENTAR en PB4 (D12)
	SBRS	R16, PB4
...
; Se deja vector vacío porque ya no usamos PORTC para botones
PINC_ISR:
	RETI
